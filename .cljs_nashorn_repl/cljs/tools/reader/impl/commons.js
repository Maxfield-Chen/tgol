...
var G__17432 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__17432;
continue;
} else {
return ch;
...
var vec__17433 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__17433,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq17436){
...
return (function() { 
var G__17441__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__17441 = function (rdr,var_args){
var _ = null;
...
while (G__17442__i < G__17442__a.length) {G__17442__a[G__17442__i] = arguments[G__17442__i + 1]; ++G__17442__i;}
  _ = new cljs.core.IndexedSeq(G__17442__a,0,null);
} 
return G__17441__delegate.call(this,rdr,_);};
G__17441.cljs$lang$maxFixedArity = 1;
G__17441.cljs$lang$applyTo = (function (arglist__17443){
var rdr = cljs.core.first(arglist__17443);
var _ = cljs.core.rest(arglist__17443);
return G__17441__delegate(rdr,_);
});
