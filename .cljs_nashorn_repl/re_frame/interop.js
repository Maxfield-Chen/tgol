...
return [(function (){var pred__13167 = cljs.core.instance_QMARK_;
var expr__13168 = reactive_val;
if(cljs.core.truth_(pred__13167.call(null,reagent.ratom.RAtom,expr__13168))){
return "ra";
} else {
if(cljs.core.truth_(pred__13167.call(null,reagent.ratom.RCursor,expr__13168))){
return "rc";
} else {
if(cljs.core.truth_(pred__13167.call(null,reagent.ratom.Reaction,expr__13168))){
return "rx";
} else {
if(cljs.core.truth_(pred__13167.call(null,reagent.ratom.Track,expr__13168))){
return "tr";
} else {
return "other";
}
